...
<body>
    ...
    <nav class="topbar">
        ...
        <div class="nav-links">
            ...
            <a href="<?php echo e(route('students.record')); ?>">Students</a>
            <a href="<?php echo e(route('students.create')); ?>" class="nav-cta">+ Add Student</a>
        </div>
    </nav>
    ...
    <div class="home-wrapper">
        <div class="home-container">
            ...
            <a href="<?php echo e(route('students.record')); ?>" class="btn-primary">View Student Records</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Laravel\experiment_2\resources\views/home.blade.php ENDPATH**/ ?>